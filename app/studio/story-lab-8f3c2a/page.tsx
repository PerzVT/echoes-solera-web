...
export const metadata: Metadata = {
  ...
  description: 'Choose Nova, Ya or Or-en, explore three training paths, encounter Titan Truffle and find a companion in Solera.',
  ...
  openGraph: {type:'website',url:'https://9livesinnovation.com/studio/story-lab-8f3c2a',title:'Solera: First Arrival',description:'Three travelers. Three training paths. One very large surprise.',images:[{url:'/story-lab/solera/assets/og-c8d5a2b16d2e.jpg',width:1200,height:630,alt:'Nova arrives in a lively Solera guild foyer'}]},
